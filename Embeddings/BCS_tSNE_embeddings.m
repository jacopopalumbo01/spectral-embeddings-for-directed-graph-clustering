function [embeddings, clusters] = BCS_tSNE_embeddings(W, k)
% BCS_embeddings - Perform cyclic spectral clustering with dimensionality
% reduction
%
% Syntax:
%        [embeddings, centroids] = BCS_tSNE_embeddings(W, k)
%
% Input Arguments:
