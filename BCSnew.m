function [cluster_indexs, centroids] = BCSnew(W, k, transition, beta, plotFlag, verbose, graph_name)
% BCS_new - Perform cyclic spectral clustering
%
% Syntax:
%        [cluster_indexs, centroids] = BCS(W, k, transition, beta, plotFlag, verbose, graph_name)
%
% Input Arguments:
...
elseif transition == "power"
    P = AdjustableCyclicTransitionMatrix(W,beta);
end
