...
%%
fprintf("Generating synthetic uniform block-acyclic graph without perturbation\n");
folder_name = sprintf("%s/Data/Synthetic/UniformBlockAcyclicNoPerturbation", pwd);
...
for i = 1:size(num_blocks,1)
    ...
    for j = 1:size(num_nodes,1)
        ...
        save(sprintf("%s/%d-blocks_%d-nodes_adj.mat", folder_name, ...
            num_blocks(i,1), num_nodes(j,1)), "W");

        save(sprintf("%s/%d-blocks_%d-nodes_lab.mat", folder_name, ...
...
%%
fprintf("Generating synthetic uniform block-acyclic graph with perturbation\n");
folder_name = sprintf("%s/Data/Synthetic/UniformBlockAcyclicPerturbation", pwd);
...
for i = 1:size(num_blocks,1)
    ...
    for j = 1:size(num_nodes,1)
        ...
        % Save graph adjacency and labels
        save(sprintf("%s/%d-blocks_%d-nodes_%f-pert_adj.mat", folder_name, ...
            num_blocks(i,1), num_nodes(j,1), epsilons(z,1)), "W");

        save(sprintf("%s/%d-blocks_%d-nodes_%f-pert_lab.mat", folder_name, ...
...
%%
fprintf("Generating synthetic block-acyclic graph without perturbation\n");
folder_name = sprintf("%s/Data/Synthetic/BlockAcyclicNoPerturbation", pwd);
...
folder_name = sprintf("%s/Data/Synthetic/BlockAcyclicPerturbation", pwd);
